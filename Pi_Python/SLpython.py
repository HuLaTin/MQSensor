#sensor array program: MQ2, MQ4, MQ5, MQ6, MQ7, MQ8, MQ9, MQ3, BME680
...
#    mq3sensorValue = mq3sensorValue + adc7.value
#    #loops 500 times
#    x=x+1
#
...
#mq3sensorValue1 = mq3sensorValue/500
#
...
#mq3RSair = ((3.3*10)/mq3sensorValue1)-10
#
...
#        mq3RSgas = ((3.3*10)/mq3sensorValue)-10
#    
...
#        COperc = COppm/10000
#    
#        Uratio = (mq3ratio-Ub)/Um #not sure what this symbol is on ds -Elizabeth
...
#              "Uppm")
    ...
    #fix for load, removes the new line
        load = load.rstrip()
